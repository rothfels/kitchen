  ...
  grunt.initConfig({
    ...
    ngconstant: {
      ...
      development: {
        constants: {
          ...
          version: '0.8.2',
          loginRedirectState: 'tab.login',
          FBURL: 'https://kitchenbase.firebaseio.com'
        }
      },
      production: {
        constants: {
    ...
    watch: {
      ...
      coffee: {
        ...
        tasks: ['clean:coffeegrind', 'coffee:globSource']
      },
      js: {
      ...
      coffeegrind: {
        files: ['<%= yeoman.app %>/coffeegrind/**/*.js'],
        tasks: ['newer:copy:app']
      },
      compass: {
    ...
    copy: {
      ...
      app: {
        ...
        src: [
          '**/*',
          // '!**/*.coffee', Useful for chrome debugging with sourcemaps.
          '!**/*.scss',
          '!**/*.sass'
        ]
      },
    ...
    karma: {
      options: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/lib/mockfirebase/dist/mockfirebase.js',
